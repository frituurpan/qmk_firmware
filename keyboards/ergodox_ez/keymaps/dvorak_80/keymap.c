 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   =    |   1  |   2  |   3  |   4  |   5  | Copy |           | Paste|   6  |   7  |   8  |   9  |   0  |  Meh   |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   '  |   ,  |   .  |   P  |   Y  | Paste|           | '/Cmd|   F  |   G  |   C  |   R  |   L  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
...
[BASE] = LAYOUT_ergodox_80(  // layer 0 : default
        // left hand
        KC_EQL,         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,  KC_LCTL(KC_C),
        KC_TAB,         KC_QUOT,      KC_COMM,KC_DOT, KC_P,   KC_Y,  KC_LCTL(KC_V),
